...
//  Copyright @ 2017 LiuFengting (https://github.com/liufengting) . All rights reserved.
//
...
private class FTPopOverMenuView: UIControl {
    ...
    fileprivate func showWithAnglePoint(point: CGPoint, frame: CGRect, menuNameArray: [String]!, menuImageArray: [UIImage]!, arrowDirection: FTPopOverMenuArrowDirection, done: @escaping ((NSInteger)->())) {
